// Problem 1529A: Eshag Loves Big Arrays
...
public class Program {
    public static void Main() {
        ...
        for (int i = 0; i < t; i++) {
            ...
            List<int> a = scanner.nextIntArray(true);
            // count the number of the smallest element in a
            // The answer is n - that number
            int trg_ind = 0;
            while (a[trg_ind] == a[0]) {
                trg_ind += 1;
                if (trg_ind == n) {
